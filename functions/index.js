...
console.log(config.user.password, config.user.email);
let mailOptions = {};
...
exports.sendMail = functions.https.onRequest((request, response) => {
  cors(request, response, () => {
    const { name, email, phone, message,total,service,platforms,features,customFeatures,users,category } = request.body;
   ...
   if(!message){
    ...
    transporter.sendMail(mailOptions, (err) => {
      if (err) {
        ...
        response.send("Sent Succsefully");
      }
    });
                                        ...
                                        >
                                          ...
                                          >
                                            ...
                                            <tr>
                                              ...
                                              >
                                          Thanks for placing your estimate request! We'll go over the details and get back to you
                                          as soon as possible.
                                              </td>
                                            </tr>
                                          </table>
